...
if __name__ == "__main__":
    ...
    #----------------------------------------------------------------------------------------------------------#
    video_path      = "C:/Users/user/Downloads/YOLO全系列/YOLOV3-tf2/yolo3-tf2-main/img/basketball.mp4"
    #video_path      = 0
    video_save_path = "C:/Users/user/Downloads/YOLO全系列/YOLOV3-tf2/yolo3-tf2-main/basketball.mp4"
    video_fps       = 25.0
    #-------------------------------------------------------------------------#
